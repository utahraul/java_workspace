...
public class Vista {
	...
	// METODO BASICO PARA MOSTRAR TEXTO
	...
	public String leer_Texto() {
		...
		// ENVOLTORIO DEL FLUJO PARA SU USO (WRAPPER)
		BufferedReader lector = new BufferedReader(flujo);
		// OBJETO DE SALIDA CON EL TEXTO ESCRITO POR EL USUARIO
		String texto = null;
		try {
			// LECTURA DE TECLADO HASTA INTRO
			texto = lector.readLine();
		} catch (IOException e) {
			// TRATAMIENTO DE EXCEPCION SI PROCEDE
		}
		// DEVOLUCION DE TEXTO ESCRITO
		return texto;
	}

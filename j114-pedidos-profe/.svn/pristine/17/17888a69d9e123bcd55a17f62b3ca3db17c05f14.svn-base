...
public class Pedido {
	...
	private Double otros_cargos_pedio;
	...
	public Double getOtros_cargos_pedio() {
		return otros_cargos_pedio;
	}

	public void setOtros_cargos_pedio(Double otros_cargos_pedio) {
		this.otros_cargos_pedio = otros_cargos_pedio;
	}
